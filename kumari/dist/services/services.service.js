...
let ServicesService = class ServicesService {
    ...
    create(createServiceDto) {
        const service = this.servicesRepository.create(Object.assign(Object.assign({}, createServiceDto), { hospital: { id: createServiceDto.hospitalId } }));
    ...
    async update(id, updateServiceDto) {
        const service = await this.servicesRepository.preload(Object.assign({ id: id }, updateServiceDto));
        if (!service) {
            throw new common_1.NotFoundException(`Service with ID ${id} not found`);
        }
        return this.servicesRepository.save(service);
